...
export const checkboxValidator: (value: boolean | undefined) => string = (
  value
) => (value === undefined ? "Checkbox is required" : "");
...
export const formWithValueValidator = (values: IUser) => {
  const { first_name: firstName, last_name: lastName, enabled } = values;
